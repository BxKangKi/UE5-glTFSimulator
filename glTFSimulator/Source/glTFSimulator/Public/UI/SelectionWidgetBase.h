...
public:
    ...
    /** Assigns the WBP class used for every generated project/world selection entry. */
    UFUNCTION(BlueprintCallable, Category="Selection|Button Widget")
    void SetSelectionButtonWidgetClass(TSubclassOf<UMenuButtonWidget> InWidgetClass);

    UFUNCTION(BlueprintPure, Category="Selection|Button Widget")
    TSubclassOf<UMenuButtonWidget> GetSelectionButtonWidgetClass() const { return SelectionButtonWidgetClass; }
...
protected:
    ...
    /**
     * WBP class used for generated buttons. Create a Blueprint derived from UMenuButtonWidget and
     * assign it here in ProjectSelectionWidget/WorldSelectionWidget Class Defaults.
     */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Selection|Button Widget")
    TSubclassOf<UMenuButtonWidget> SelectionButtonWidgetClass;
