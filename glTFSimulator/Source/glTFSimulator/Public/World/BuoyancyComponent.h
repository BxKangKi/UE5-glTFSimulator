...
struct GLTFSIMULATOR_API FBuoyancyPhysicsSettings
{
    GENERATED_BODY()

    /** Per-sample force safety cap. */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Physics", meta=(ClampMin="1.0"))
    float BuoyancyForcePerPoint = 45000.0f;

    /** 1.0 means neutral lift for a fully submerged body. */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Physics", meta=(ClampMin="0.0", ClampMax="2.0"))
    float BuoyancyAccelerationScale = 0.990f;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Physics", meta=(ClampMin="1.0"))
    float SubmersionDepth = 320.0f;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Physics", meta=(ClampMin="0.0"))
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Physics|Drag", meta=(ClampMin="0.0"))
    float WaterLinearDragCoefficient = 2.05f;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Physics|Drag", meta=(ClampMin="0.0"))
    float WaterQuadraticDragCoefficient = 0.00155f;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Physics|Drag", meta=(ClampMin="1.0"))
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Physics|Drag", meta=(ClampMin="0.1"))
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Physics|Drag", meta=(ClampMin="0.0", ClampMax="0.95"))
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Physics|Stability", meta=(ClampMin="0.001", ClampMax="0.1"))
    float MaxBuoyancyStepSeconds = 0.016667f;

    /** Per-substep velocity-change cap, in cm/s, for buoyancy + drag impulses. */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Physics|Stability", meta=(ClampMin="1.0"))
    float MaxImpulseVelocityChangePerStep = 185.0f;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Physics|Stability")
    bool bClampLinearVelocity = true;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Physics|Stability", meta=(ClampMin="1.0", EditCondition="bClampLinearVelocity"))
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Physics|Stability", meta=(ClampMin="1.0", EditCondition="bLimitDownwardSinkSpeed"))
    float MaxDownwardSinkSpeed = 80.0f;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Physics|Stability", meta=(ClampMin="0.0", EditCondition="bLimitDownwardSinkSpeed"))
    float SinkSpeedSoftClampInterpSpeed = 8.0f;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Physics|Stability", meta=(ClampMin="0.0", ClampMax="1.0", EditCondition="bLimitDownwardSinkSpeed"))
    float SinkSpeedClampMinSubmergedAlpha = 0.18f;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Physics|Stability")
    bool bClampAngularVelocity = true;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Physics|Stability", meta=(ClampMin="0.1", EditCondition="bClampAngularVelocity"))
    float MaxAngularSpeed = 5.0f;
};

USTRUCT(BlueprintType)
struct GLTFSIMULATOR_API FSkeletalBuoyancyBoneRule
{
    GENERATED_BODY()

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Skeletal Mesh")
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Skeletal Mesh", meta=(EditCondition="bExcludeFromPrimaryBuoyancy"))
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Skeletal Mesh", meta=(EditCondition="bOverridePhysicsSettings"))
    FBuoyancyPhysicsSettings PhysicsSettings;
};

USTRUCT(BlueprintType)
struct GLTFSIMULATOR_API FSkeletalBuoyancySettings
{
    GENERATED_BODY()
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Skeletal Mesh", meta=(ClampMin="1", ClampMax="32"))
    int32 MaxBodySamples = 24;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Skeletal Mesh", meta=(ClampMin="1", ClampMax="16"))
    int32 MinSimulatedBodiesForBuoyancy = 4;

    /** Dynamically loaded skeletal meshes can report tiny aggregate mass. This prevents underpowered buoyancy. */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Skeletal Mesh", meta=(ClampMin="1.0"))
    float TotalMassFloor = 70.0f;

    /** First matching rule wins. Put exact/special rules before broader pattern rules. */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy|Skeletal Mesh")
    TArray<FSkeletalBuoyancyBoneRule> BoneRules;
};
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category="Buoyancy")
    void SetCommonPhysicsSettings(const FBuoyancyPhysicsSettings& InSettings);

    UFUNCTION(BlueprintPure, Category="Buoyancy")
    FBuoyancyPhysicsSettings GetCommonPhysicsSettings() const { return CommonPhysicsSettings; }

    UFUNCTION(BlueprintCallable, Category="Buoyancy")
    void SetSkeletalMeshSettings(const FSkeletalBuoyancySettings& InSettings);

    UFUNCTION(BlueprintPure, Category="Buoyancy")
    FSkeletalBuoyancySettings GetSkeletalMeshSettings() const { return SkeletalMeshSettings; }
...
protected:
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy")
    FBuoyancyPhysicsSettings CommonPhysicsSettings;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy")
    FSkeletalBuoyancySettings SkeletalMeshSettings;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Buoyancy", meta=(ClampMin="1"))
...
private:
    ...
    /** Effective state (local overlap or global-ocean height test). */
    bool bInWater = false;
    /** Local-water overlap state is tracked separately so global-ocean probing can clear itself safely. */
    bool bOverlapWater = false;
    float WaterLevel = 0.0f;
    float OverlapWaterLevel = 0.0f;
    ...
    void UpdateBuoyancyFromGameUpdate(float DeltaTime);
    UPrimitiveComponent* ResolveTargetPrimitive();
    void ClearAutoGeneratedSamplePoints();
    bool ApplySkeletalMeshBuoyancy(USkeletalMeshComponent* SkeletalMesh, float DeltaTime, const TArray<FWaterExclusionNativeBox>& ExclusionBoxes);
};
