...
class GLTFSIMULATOR_API AEditableMeshActor : public AActor
{
    GENERATED_BODY()
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category="Mesh Edit")
    void BeginObject(const FString& InObjectName);
    ...
    UFUNCTION(BlueprintPure, Category="Mesh Edit")
    ...
    UFUNCTION(BlueprintCallable, Category="Mesh Edit|Preview")
    ...
    UFUNCTION(BlueprintCallable, Category="Mesh Edit")
    FGeneratedMeshRecord ToGeneratedMeshRecord() const;

    UFUNCTION(BlueprintCallable, Category="Mesh Edit")
    void LoadFromGeneratedMeshRecord(const FGeneratedMeshRecord& Record);
    ...
    UFUNCTION(BlueprintPure, Category="Mesh Edit|Preview")
    ...
    UFUNCTION(BlueprintPure, Category="Mesh Edit|Selection")
...
private:
    UPROPERTY(VisibleAnywhere, Category="Mesh Edit")
    ...
    UPROPERTY(VisibleAnywhere, Category="Mesh Edit|Preview")
    TObjectPtr<UProceduralMeshComponent> PreviewComponent;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Mesh Edit|Preview", meta=(AllowPrivateAccess="true"))
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Mesh Edit|Materials", meta=(AllowPrivateAccess="true"))
