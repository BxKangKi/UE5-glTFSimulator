...
#define DIRECTORY_EXTERNAL_RESOURCES TEXT("Resources")
#define DIRECTORY_PROJECT_RESOURCES TEXT("resources")
...
#define PATH_EXTERNAL_RESOURCES FPaths::Combine(DIRECTORY_USER, DIRECTORY_GAME, DIRECTORY_EXTERNAL_RESOURCES)
