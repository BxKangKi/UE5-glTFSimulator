...
public:
    ...
    /** Runtime-only load. InModelReference must resolve to an immutable .gworld member. */
...
private:
    ...
    UPROPERTY()
    /** Range-reading facade for one gworld:// model; it never contains or opens a source GLB. */
